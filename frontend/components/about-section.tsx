    ...
    <section className="py-16 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-dark-blue-800 mb-4">About IST Lab</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <div className="bg-white rounded-lg shadow-xl p-8">
              <h3 className="text-2xl font-bold text-dark-blue-800 mb-4">IST Lab 소개</h3>
              ...
              <div className="grid grid-cols-2 gap-4 text-center">
                <div className="bg-dark-blue-50 p-4 rounded-lg">
                  <div className="text-2xl font-bold text-dark-blue-800">2005</div>
                  <div className="text-sm text-gray-600">설립년도</div>
                </div>
                <div className="bg-dark-blue-50 p-4 rounded-lg">
                  <div className="text-2xl font-bold text-dark-blue-800">19년</div>
          ...
          <div className="space-y-6">
            <div className="bg-dark-blue-800 text-white p-6 rounded-lg">
            ...
            <div className="bg-dark-blue-700 text-white p-6 rounded-lg">
              <div className="flex items-center mb-3">
            ...
            <div className="bg-dark-blue-900 text-white p-6 rounded-lg">
              <div className="flex items-center mb-3">
        ...
        <div className="bg-gray-50 rounded-lg p-8">
          <h3 className="text-2xl font-bold text-dark-blue-800 mb-6 text-center">주요 연구 분야</h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="w-16 h-16 bg-dark-blue-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <div className="w-8 h-8 bg-dark-blue-800 rounded"></div>
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-dark-blue-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <div className="w-8 h-8 bg-dark-blue-800 rounded-full"></div>
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-dark-blue-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <div className="w-8 h-8 bg-dark-blue-800 rounded-lg transform rotate-45"></div>
              </div>
