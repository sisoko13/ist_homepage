export default function Footer() {
  return (
    <footer className="bg-dark-blue-900 text-white py-10">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center">
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap justify-center items-center gap-4 text-sm text-dark-blue-200">
        ...
        <div className="border-t border-dark-blue-700 mt-8 pt-8 text-center text-sm text-dark-blue-200">
          <p>
